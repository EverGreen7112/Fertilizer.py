...
low_hsv_range = (table.getNumber("lowh", veg.HSV_ranges.LIFECAM_3000.Reflector.lowH), table.getNumber("lows", veg.HSV_ranges.LIFECAM_3000.Reflector.lowS), table.getNumber("lowv", veg.HSV_ranges.LIFECAM_3000.Reflector.lowV))
high_hsv_range = (table.getNumber("highh", veg.HSV_ranges.LIFECAM_3000.Reflector.highH), table.getNumber("highs", veg.HSV_ranges.LIFECAM_3000.Reflector.highS), table.getNumber("highv", veg.HSV_ranges.LIFECAM_3000.Reflector.highV))
...
while True:
    ...
    if len(contours) > 0:
        ...
        distance = shape.calculate_distance(veg.Reflector.center_height, veg.Cameras.LIFECAM_3000.height, veg.Cameras.LIFECAM_3000.angle, veg.Cameras.LIFECAM_3000.vertical_fov, veg.Cameras.LIFECAM_3000.middle)
